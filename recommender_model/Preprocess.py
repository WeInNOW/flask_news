...
class Preprocess:
    ...
    def Tokenize(art_contents, stopwords_txt):
        ...
        return otoken_array # 返回所有可用词,是一个二维数组
    #输入：词例
